...
describe("Multistore", () => {
  ...
  describe("adjustMultistoreApiUrl", () => {
    ...
    it("returns URL /test with storeCode de as parameter", () => {
      ...
      expect(adjustMultistoreApiUrl("/test")).toStrictEqual(
        "/test?storeCode=de"
      );
    });
    ...
    it("returns URL /test?a=b with storeCode de as parameter and current parameters from the URL", () => {
      ...
      expect(adjustMultistoreApiUrl("/test?a=b")).toStrictEqual(
        "/test?a=b&storeCode=de"
      );
    });
    ...
    it("returns URL /test?storeCode=de with changed storeCode at as parameter", () => {
      ...
      expect(adjustMultistoreApiUrl("/test?storeCode=de")).toStrictEqual(
        "/test?storeCode=at"
      );
    });
    ...
    it("returns URL /test?storeCode=de with changed storeCode at as parameter", () => {
      ...
      expect(
        adjustMultistoreApiUrl("/test?storeCode=de&storeCode=de")
      ).toStrictEqual("/test?storeCode=at");
    });
  });
  ...
  describe("localizedDispatcherRoute", () => {
    ...
    it("URL /test?a=b&b=a stays the same", () => {
      ...
      expect(localizedDispatcherRoute("/test?a=b&b=a", "de")).toStrictEqual(
        "/test?a=b&b=a"
      );
    });
    ...
    it("URL with  LocalizedRoute object with fullPath test gets prefixed with /de", () => {
      ...
      expect(localizedDispatcherRoute(LocalizedRoute, "de")).toStrictEqual(
        "/test"
      );
    });
  ...
  describe("localizedRouteConfig", () => {
    ...
    it("change only route name for child route", () => {
      ...
      expect(localizedRouteConfig(childRoute, storeCode, true)).toEqual(
        expectedRoute
      );
    });
